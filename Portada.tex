...
\fancyhead[LE,RO]{\footnotesize\TituloAbreviado}
\fancyhead[RE,LO]{\footnotesize\Estudiante}
\fancyfoot[LE,RO]{\footnotesize\thepage}
\fancyfoot[RE,LO]{\footnotesize Escuela Politécnica Superior de Jaén}
...
\newcommand{\Portada}{ %
    ...
    \begin{textblock*}{18.45cm}(1.4cm,10.5cm) 
        \centering
